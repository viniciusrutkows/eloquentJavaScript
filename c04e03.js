...
value: 1 rest: { value: 2  rest: { value: rest: null }}};
...
const vetorDeNumeros = [1, 2, 3];
const iterador = vetorDeNumeros.keys();
let list = {};

function tranformarVetorEmLista() {
